      ...
      <AnimatePresence>
        {open && (
          ...
          className="size-80 h-[32rem]! bg-neutral-50  flex rounded-xl shadow-aceCard p-4 flex-col gap-2">
            ...
            >
              Beautiful and modern UI components built with Tailwind CSS and
              Framer Motion.
            </p>
            <div
              id="button-container"
            ...
            <motion.div className="relative h-full bg-gray-100 mt-4 flex flex-1 border border-dashed border-neutral-200 rounded-lg">
              {/* Motion divs start */}
              <motion.div
                initial={{
                  opacity: 0,
